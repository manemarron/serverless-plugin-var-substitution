...
describe('Plugin', () => {
    ...
    describe('handle', () => {
        ...
        it('should replace variables correctly when variables are {search: "<something>", replace: "<something_else>"', () => {
            // Arrange
        ...
        it('should replace variables correctly when variables are strings', () => {
            // Arrange
            systemUnderTest.variables = ["hello", "world"];
            systemUnderTest.pattern = '##';
            systemUnderTest.serverless = {
                service: {
                    provider: {
